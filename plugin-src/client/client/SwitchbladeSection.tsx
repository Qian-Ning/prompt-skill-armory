        ...
        <div style={CSS.columns}>
          <div style={CSS.column}>
            ...
            <div style={CSS.cliBox}>
              ...
              <code style={{ fontSize: '10px', color: PHOSPHOR }}>/sw-skill-dir &lt;目录&gt;</code><br />
              <code style={{ fontSize: '10px', color: PHOSPHOR }}>/sw-install-zip &lt;zip路径&gt;</code>
            </div>
          </div>
          <div style={CSS.column}>
